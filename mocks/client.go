...
//
//	mockgen -source gocloak_iface.go -destination mocks/client.go
//

// Package mock_gocloak is a generated GoMock package.
package mock_gocloak
...
import (
	...
	v13 "github.com/WilSimpson/gocloak/v13"
...
func (m *MockGoCloakIface) AddClientRoleComposite(ctx context.Context, token, realm, roleID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddClientRoleToGroup(ctx context.Context, token, realm, idOfClient, groupID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddClientRoleToUser(ctx context.Context, token, realm, idOfClient, userID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddClientRolesToGroup(ctx context.Context, token, realm, idOfClient, groupID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddClientRolesToUser(ctx context.Context, token, realm, idOfClient, userID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddRealmRoleComposite(ctx context.Context, token, realm, roleName string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddRealmRoleToGroup(ctx context.Context, token, realm, groupID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) AddRealmRoleToUser(ctx context.Context, token, realm, userID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateAuthenticationExecution(ctx context.Context, token, realm, flow string, execution v13.CreateAuthenticationExecutionRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateAuthenticationExecutionFlow(ctx context.Context, token, realm, flow string, executionFlow v13.CreateAuthenticationExecutionFlowRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateAuthenticationFlow(ctx context.Context, token, realm string, flow v13.AuthenticationFlowRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateChildGroup(ctx context.Context, token, realm, groupID string, group v13.Group) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClient(ctx context.Context, accessToken, realm string, newClient v13.Client) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientProtocolMapper(ctx context.Context, token, realm, idOfClient string, mapper v13.ProtocolMapperRepresentation) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientRepresentation(ctx context.Context, token, realm string, newClient v13.Client) (*v13.Client, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateClientRepresentation", ctx, token, realm, newClient)
	ret0, _ := ret[0].(*v13.Client)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreateClientRole(ctx context.Context, token, realm, idOfClient string, role v13.Role) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientScope(ctx context.Context, token, realm string, scope v13.ClientScope) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientScopeMappingsRealmRoles(ctx context.Context, token, realm, idOfClient string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID string, protocolMapper v13.ProtocolMappers) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientScopesScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClientScope, idOfClient string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateComponent(ctx context.Context, token, realm string, component v13.Component) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateGroup(ctx context.Context, token, realm string, group v13.Group) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateIdentityProvider(ctx context.Context, token, realm string, providerRep v13.IdentityProviderRepresentation) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateIdentityProviderMapper(ctx context.Context, token, realm, alias string, mapper v13.IdentityProviderMapper) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreatePermission(ctx context.Context, token, realm, idOfClient string, permission v13.PermissionRepresentation) (*v13.PermissionRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePermission", ctx, token, realm, idOfClient, permission)
	ret0, _ := ret[0].(*v13.PermissionRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreatePermissionTicket(ctx context.Context, token, realm string, permissions []v13.CreatePermissionTicketParams) (*v13.PermissionTicketResponseRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePermissionTicket", ctx, token, realm, permissions)
	ret0, _ := ret[0].(*v13.PermissionTicketResponseRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreatePolicy(ctx context.Context, token, realm, idOfClient string, policy v13.PolicyRepresentation) (*v13.PolicyRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePolicy", ctx, token, realm, idOfClient, policy)
	ret0, _ := ret[0].(*v13.PolicyRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreateRealm(ctx context.Context, token string, realm v13.RealmRepresentation) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateRealmRole(ctx context.Context, token, realm string, role v13.Role) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateResource(ctx context.Context, token, realm, idOfClient string, resource v13.ResourceRepresentation) (*v13.ResourceRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateResource", ctx, token, realm, idOfClient, resource)
	ret0, _ := ret[0].(*v13.ResourceRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreateResourceClient(ctx context.Context, token, realm string, resource v13.ResourceRepresentation) (*v13.ResourceRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateResourcePolicy(ctx context.Context, token, realm, resourceID string, policy v13.ResourcePolicyRepresentation) (*v13.ResourcePolicyRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateResourcePolicy", ctx, token, realm, resourceID, policy)
	ret0, _ := ret[0].(*v13.ResourcePolicyRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreateScope(ctx context.Context, token, realm, idOfClient string, scope v13.ScopeRepresentation) (*v13.ScopeRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateScope", ctx, token, realm, idOfClient, scope)
	ret0, _ := ret[0].(*v13.ScopeRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) CreateUser(ctx context.Context, token, realm string, user v13.User) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) CreateUserFederatedIdentity(ctx context.Context, token, realm, userID, providerID string, federatedIdentityRep v13.FederatedIdentityRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DecodeAccessToken(ctx context.Context, accessToken, realm string) (*v5.Token, *v5.MapClaims, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DecodeAccessToken", ctx, accessToken, realm)
	ret0, _ := ret[0].(*v5.Token)
	ret1, _ := ret[1].(*v5.MapClaims)
	ret2, _ := ret[2].(error)
...
func (m *MockGoCloakIface) DecodeAccessTokenCustomClaims(ctx context.Context, accessToken, realm string, claims v5.Claims) (*v5.Token, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientRoleComposite(ctx context.Context, token, realm, roleID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientRoleFromGroup(ctx context.Context, token, realm, idOfClient, groupID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientRoleFromUser(ctx context.Context, token, realm, idOfClient, userID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientRolesFromUser(ctx context.Context, token, realm, idOfClient, userID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientScopeMappingsRealmRoles(ctx context.Context, token, realm, idOfClient string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientScopesScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClientScope, idOfClient string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteRealmRoleComposite(ctx context.Context, token, realm, roleName string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteRealmRoleFromGroup(ctx context.Context, token, realm, groupID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) DeleteRealmRoleFromUser(ctx context.Context, token, realm, userID string, roles []v13.Role) error {
	m.ctrl.T.Helper()
...
// DirectNakedImpersonationTokenExchange mocks base method.
func (m *MockGoCloakIface) DirectNakedImpersonationTokenExchange(ctx context.Context, clientID, clientSecret, realm, userID string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DirectNakedImpersonationTokenExchange", ctx, clientID, clientSecret, realm, userID)
	ret0, _ := ret[0].(*v13.JWT)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DirectNakedImpersonationTokenExchange indicates an expected call of DirectNakedImpersonationTokenExchange.
func (mr *MockGoCloakIfaceMockRecorder) DirectNakedImpersonationTokenExchange(ctx, clientID, clientSecret, realm, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DirectNakedImpersonationTokenExchange", reflect.TypeOf((*MockGoCloakIface)(nil).DirectNakedImpersonationTokenExchange), ctx, clientID, clientSecret, realm, userID)
}
...
func (m *MockGoCloakIface) ExecuteActionsEmail(ctx context.Context, token, realm string, params v13.ExecuteActionsEmail) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetAdapterConfiguration(ctx context.Context, accessToken, realm, clientID string) (*v13.AdapterConfiguration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAdapterConfiguration", ctx, accessToken, realm, clientID)
	ret0, _ := ret[0].(*v13.AdapterConfiguration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetAuthenticationExecutions(ctx context.Context, token, realm, flow string) ([]*v13.ModifyAuthenticationExecutionRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAuthenticationExecutions", ctx, token, realm, flow)
	ret0, _ := ret[0].([]*v13.ModifyAuthenticationExecutionRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetAuthenticationFlow(ctx context.Context, token, realm, authenticationFlowID string) (*v13.AuthenticationFlowRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAuthenticationFlow", ctx, token, realm, authenticationFlowID)
	ret0, _ := ret[0].(*v13.AuthenticationFlowRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetAuthenticationFlows(ctx context.Context, token, realm string) ([]*v13.AuthenticationFlowRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetAuthorizationPolicyAssociatedPolicies(ctx context.Context, token, realm, idOfClient, policyID string) ([]*v13.PolicyRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetAuthorizationPolicyResources(ctx context.Context, token, realm, idOfClient, policyID string) ([]*v13.PolicyResourceRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAuthorizationPolicyResources", ctx, token, realm, idOfClient, policyID)
	ret0, _ := ret[0].([]*v13.PolicyResourceRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetAuthorizationPolicyScopes(ctx context.Context, token, realm, idOfClient, policyID string) ([]*v13.PolicyScopeRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAuthorizationPolicyScopes", ctx, token, realm, idOfClient, policyID)
	ret0, _ := ret[0].([]*v13.PolicyScopeRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetAvailableClientRolesByGroupID(ctx context.Context, token, realm, idOfClient, groupID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetAvailableClientRolesByUserID(ctx context.Context, token, realm, idOfClient, userID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetAvailableRealmRolesByGroupID(ctx context.Context, token, realm, groupID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetAvailableRealmRolesByUserID(ctx context.Context, token, realm, userID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCerts(ctx context.Context, realm string) (*v13.CertResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCerts", ctx, realm)
	ret0, _ := ret[0].(*v13.CertResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetChildGroups mocks base method.
func (m *MockGoCloakIface) GetChildGroups(ctx context.Context, token, realm, groupID string, params v13.GetChildGroupsParams) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetChildGroups", ctx, token, realm, groupID, params)
	ret0, _ := ret[0].([]*v13.Group)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetChildGroups indicates an expected call of GetChildGroups.
func (mr *MockGoCloakIfaceMockRecorder) GetChildGroups(ctx, token, realm, groupID, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetChildGroups", reflect.TypeOf((*MockGoCloakIface)(nil).GetChildGroups), ctx, token, realm, groupID, params)
}

// GetClient mocks base method.
func (m *MockGoCloakIface) GetClient(ctx context.Context, token, realm, idOfClient string) (*v13.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientManagementPermissions(ctx context.Context, token, realm, idOfClient string) (*v13.ManagementPermissionRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientManagementPermissions", ctx, token, realm, idOfClient)
	ret0, _ := ret[0].(*v13.ManagementPermissionRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetClientOfflineSessions(ctx context.Context, token, realm, idOfClient string, params ...v13.GetClientUserSessionsParams) ([]*v13.UserSessionRepresentation, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, token, realm, idOfClient}
	for _, a := range params {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetClientOfflineSessions", varargs...)
	ret0, _ := ret[0].([]*v13.UserSessionRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetClientOfflineSessions indicates an expected call of GetClientOfflineSessions.
func (mr *MockGoCloakIfaceMockRecorder) GetClientOfflineSessions(ctx, token, realm, idOfClient any, params ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, token, realm, idOfClient}, params...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClientOfflineSessions", reflect.TypeOf((*MockGoCloakIface)(nil).GetClientOfflineSessions), varargs...)
}

// GetClientRepresentation mocks base method.
func (m *MockGoCloakIface) GetClientRepresentation(ctx context.Context, accessToken, realm, clientID string) (*v13.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientRole(ctx context.Context, token, realm, idOfClient, roleName string) (*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientRoleByID(ctx context.Context, token, realm, roleID string) (*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientRoles(ctx context.Context, token, realm, idOfClient string, params v13.GetRoleParams) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientRolesByGroupID(ctx context.Context, token, realm, idOfClient, groupID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientRolesByUserID(ctx context.Context, token, realm, idOfClient, userID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScope(ctx context.Context, token, realm, scopeID string) (*v13.ClientScope, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientScope", ctx, token, realm, scopeID)
	ret0, _ := ret[0].(*v13.ClientScope)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetClientScopeMappings(ctx context.Context, token, realm, idOfClient string) (*v13.MappingsRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientScopeMappings", ctx, token, realm, idOfClient)
	ret0, _ := ret[0].(*v13.MappingsRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetClientScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopeMappingsClientRolesAvailable(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopeMappingsRealmRoles(ctx context.Context, token, realm, idOfClient string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopeMappingsRealmRolesAvailable(ctx context.Context, token, realm, idOfClient string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID, protocolMapperID string) (*v13.ProtocolMappers, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientScopeProtocolMapper", ctx, token, realm, scopeID, protocolMapperID)
	ret0, _ := ret[0].(*v13.ProtocolMappers)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetClientScopeProtocolMappers(ctx context.Context, token, realm, scopeID string) ([]*v13.ProtocolMappers, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopes(ctx context.Context, token, realm string) ([]*v13.ClientScope, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopesScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClientScope, idOfClient string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopesScopeMappingsClientRolesAvailable(ctx context.Context, token, realm, idOfClientScope, idOfClient string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientScopesScopeMappingsRealmRolesAvailable(ctx context.Context, token, realm, clientScopeID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientSecret(ctx context.Context, token, realm, idOfClient string) (*v13.CredentialRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientSecret", ctx, token, realm, idOfClient)
	ret0, _ := ret[0].(*v13.CredentialRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetClientServiceAccount(ctx context.Context, token, realm, idOfClient string) (*v13.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientServiceAccount", ctx, token, realm, idOfClient)
	ret0, _ := ret[0].(*v13.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetClientUserSessions(ctx context.Context, token, realm, idOfClient string, params ...v13.GetClientUserSessionsParams) ([]*v13.UserSessionRepresentation, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, token, realm, idOfClient}
	for _, a := range params {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetClientUserSessions", varargs...)
	ret0, _ := ret[0].([]*v13.UserSessionRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockGoCloakIfaceMockRecorder) GetClientUserSessions(ctx, token, realm, idOfClient any, params ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, token, realm, idOfClient}, params...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClientUserSessions", reflect.TypeOf((*MockGoCloakIface)(nil).GetClientUserSessions), varargs...)
}

// GetClients mocks base method.
func (m *MockGoCloakIface) GetClients(ctx context.Context, token, realm string, params v13.GetClientsParams) ([]*v13.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientsDefaultScopes(ctx context.Context, token, realm, idOfClient string) ([]*v13.ClientScope, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetClientsOptionalScopes(ctx context.Context, token, realm, idOfClient string) ([]*v13.ClientScope, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetComponent(ctx context.Context, token, realm, componentID string) (*v13.Component, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetComponent", ctx, token, realm, componentID)
	ret0, _ := ret[0].(*v13.Component)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetComponents(ctx context.Context, token, realm string) ([]*v13.Component, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetComponentsWithParams(ctx context.Context, token, realm string, params v13.GetComponentsParams) ([]*v13.Component, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeClientRolesByGroupID(ctx context.Context, token, realm, idOfClient, groupID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeClientRolesByRoleID(ctx context.Context, token, realm, idOfClient, roleID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeClientRolesByUserID(ctx context.Context, token, realm, idOfClient, userID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeRealmRoles(ctx context.Context, token, realm, roleName string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeRealmRolesByGroupID(ctx context.Context, token, realm, groupID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeRealmRolesByRoleID(ctx context.Context, token, realm, roleID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeRealmRolesByUserID(ctx context.Context, token, realm, userID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCompositeRolesByRoleID(ctx context.Context, token, realm, roleID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetCredentials(ctx context.Context, token, realm, userID string) ([]*v13.CredentialRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetDefaultDefaultClientScopes(ctx context.Context, token, realm string) ([]*v13.ClientScope, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetDefaultGroups(ctx context.Context, token, realm string) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetDefaultOptionalClientScopes(ctx context.Context, token, realm string) ([]*v13.ClientScope, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetDependentPermissions(ctx context.Context, token, realm, idOfClient, policyID string) ([]*v13.PermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetEvents(ctx context.Context, token, realm string, params v13.GetEventsParams) ([]*v13.EventRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEvents", ctx, token, realm, params)
	ret0, _ := ret[0].([]*v13.EventRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetGroup(ctx context.Context, token, realm, groupID string) (*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroupByPath(ctx context.Context, token, realm, groupPath string) (*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroupManagementPermissions(ctx context.Context, token, realm, idOfGroup string) (*v13.ManagementPermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroupMembers(ctx context.Context, token, realm, groupID string, params v13.GetGroupsParams) ([]*v13.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroups(ctx context.Context, token, realm string, params v13.GetGroupsParams) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroupsByClientRole(ctx context.Context, token, realm, roleName, clientID string) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroupsByRole(ctx context.Context, token, realm, roleName string) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetGroupsCount(ctx context.Context, token, realm string, params v13.GetGroupsParams) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetIdentityProvider(ctx context.Context, token, realm, alias string) (*v13.IdentityProviderRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIdentityProvider", ctx, token, realm, alias)
	ret0, _ := ret[0].(*v13.IdentityProviderRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetIdentityProviderMapper(ctx context.Context, token, realm, alias, mapperID string) (*v13.IdentityProviderMapper, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIdentityProviderMapper", ctx, token, realm, alias, mapperID)
	ret0, _ := ret[0].(*v13.IdentityProviderMapper)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetIdentityProviderMapperByID(ctx context.Context, token, realm, alias, mapperID string) (*v13.IdentityProviderMapper, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetIdentityProviderMappers(ctx context.Context, token, realm, alias string) ([]*v13.IdentityProviderMapper, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetIdentityProviders(ctx context.Context, token, realm string) ([]*v13.IdentityProviderRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetIssuer(ctx context.Context, realm string) (*v13.IssuerResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIssuer", ctx, realm)
	ret0, _ := ret[0].(*v13.IssuerResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetKeyStoreConfig(ctx context.Context, token, realm string) (*v13.KeyStoreConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetKeyStoreConfig", ctx, token, realm)
	ret0, _ := ret[0].(*v13.KeyStoreConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetPermission(ctx context.Context, token, realm, idOfClient, permissionID string) (*v13.PermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetPermissionResources(ctx context.Context, token, realm, idOfClient, permissionID string) ([]*v13.PermissionResource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPermissionResources", ctx, token, realm, idOfClient, permissionID)
	ret0, _ := ret[0].([]*v13.PermissionResource)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetPermissionScope(ctx context.Context, token, realm, idOfClient, idOfScope string) (*v13.PolicyRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetPermissionScopes(ctx context.Context, token, realm, idOfClient, permissionID string) ([]*v13.PermissionScope, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPermissionScopes", ctx, token, realm, idOfClient, permissionID)
	ret0, _ := ret[0].([]*v13.PermissionScope)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetPermissions(ctx context.Context, token, realm, idOfClient string, params v13.GetPermissionParams) ([]*v13.PermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetPolicies(ctx context.Context, token, realm, idOfClient string, params v13.GetPolicyParams) ([]*v13.PolicyRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetPolicy(ctx context.Context, token, realm, idOfClient, policyID string) (*v13.PolicyRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRealm(ctx context.Context, token, realm string) (*v13.RealmRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRealm", ctx, token, realm)
	ret0, _ := ret[0].(*v13.RealmRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetRealmRole(ctx context.Context, token, realm, roleName string) (*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRealmRoleByID(ctx context.Context, token, realm, roleID string) (*v13.Role, error) {
	m.ctrl.T.Helper()
...
// GetRealmRoleGroups mocks base method.
func (m *MockGoCloakIface) GetRealmRoleGroups(ctx context.Context, token, roleName, realm string) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRealmRoleGroups", ctx, token, roleName, realm)
	ret0, _ := ret[0].([]*v13.Group)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRealmRoleGroups indicates an expected call of GetRealmRoleGroups.
func (mr *MockGoCloakIfaceMockRecorder) GetRealmRoleGroups(ctx, token, roleName, realm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRealmRoleGroups", reflect.TypeOf((*MockGoCloakIface)(nil).GetRealmRoleGroups), ctx, token, roleName, realm)
}

// GetRealmRoles mocks base method.
func (m *MockGoCloakIface) GetRealmRoles(ctx context.Context, token, realm string, params v13.GetRoleParams) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRealmRolesByGroupID(ctx context.Context, token, realm, groupID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRealmRolesByUserID(ctx context.Context, token, realm, userID string) ([]*v13.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRealms(ctx context.Context, token string) ([]*v13.RealmRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequest(ctx context.Context) *v2.Request {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequestWithBasicAuth(ctx context.Context, clientID, clientSecret string) *v2.Request {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequestWithBearerAuth(ctx context.Context, token string) *v2.Request {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequestWithBearerAuthNoCache(ctx context.Context, token string) *v2.Request {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequestWithBearerAuthXMLHeader(ctx context.Context, token string) *v2.Request {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequestingPartyPermissionDecision(ctx context.Context, token, realm string, options v13.RequestingPartyTokenOptions) (*v13.RequestingPartyPermissionDecision, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRequestingPartyPermissionDecision", ctx, token, realm, options)
	ret0, _ := ret[0].(*v13.RequestingPartyPermissionDecision)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetRequestingPartyPermissions(ctx context.Context, token, realm string, options v13.RequestingPartyTokenOptions) (*[]v13.RequestingPartyPermission, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRequestingPartyPermissions", ctx, token, realm, options)
	ret0, _ := ret[0].(*[]v13.RequestingPartyPermission)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetRequestingPartyToken(ctx context.Context, token, realm string, options v13.RequestingPartyTokenOptions) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRequiredAction(ctx context.Context, token, realm, alias string) (*v13.RequiredActionProviderRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRequiredAction", ctx, token, realm, alias)
	ret0, _ := ret[0].(*v13.RequiredActionProviderRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetRequiredActions(ctx context.Context, token, realm string) ([]*v13.RequiredActionProviderRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetResource(ctx context.Context, token, realm, idOfClient, resourceID string) (*v13.ResourceRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetResourceClient(ctx context.Context, token, realm, resourceID string) (*v13.ResourceRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetResourcePolicies(ctx context.Context, token, realm string, params v13.GetResourcePoliciesParams) ([]*v13.ResourcePolicyRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetResourcePolicy(ctx context.Context, token, realm, permissionID string) (*v13.ResourcePolicyRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetResourceServer(ctx context.Context, token, realm, idOfClient string) (*v13.ResourceServerRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResourceServer", ctx, token, realm, idOfClient)
	ret0, _ := ret[0].(*v13.ResourceServerRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetResources(ctx context.Context, token, realm, idOfClient string, params v13.GetResourceParams) ([]*v13.ResourceRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetResourcesClient(ctx context.Context, token, realm string, params v13.GetResourceParams) ([]*v13.ResourceRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRoleMappingByGroupID(ctx context.Context, token, realm, groupID string) (*v13.MappingsRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetRoleMappingByUserID(ctx context.Context, token, realm, userID string) (*v13.MappingsRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetScope(ctx context.Context, token, realm, idOfClient, scopeID string) (*v13.ScopeRepresentation, error) {
	m.ctrl.T.Helper()
...
// GetScopePermissions mocks base method.
func (m *MockGoCloakIface) GetScopePermissions(ctx context.Context, token, realm, idOfClient, idOfScope string) ([]*v13.PolicyRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetScopePermissions", ctx, token, realm, idOfClient, idOfScope)
	ret0, _ := ret[0].([]*v13.PolicyRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetScopePermissions indicates an expected call of GetScopePermissions.
func (mr *MockGoCloakIfaceMockRecorder) GetScopePermissions(ctx, token, realm, idOfClient, idOfScope any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetScopePermissions", reflect.TypeOf((*MockGoCloakIface)(nil).GetScopePermissions), ctx, token, realm, idOfClient, idOfScope)
}

// GetScopes mocks base method.
func (m *MockGoCloakIface) GetScopes(ctx context.Context, token, realm, idOfClient string, params v13.GetScopeParams) ([]*v13.ScopeRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetServerInfo(ctx context.Context, accessToken string) (*v13.ServerInfoRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServerInfo", ctx, accessToken)
	ret0, _ := ret[0].(*v13.ServerInfoRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetToken(ctx context.Context, realm string, options v13.TokenOptions) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
// GetUnregisteredRequiredActions mocks base method.
func (m *MockGoCloakIface) GetUnregisteredRequiredActions(ctx context.Context, token, realm string) ([]*v13.UnregisteredRequiredActionProviderRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUnregisteredRequiredActions", ctx, token, realm)
	ret0, _ := ret[0].([]*v13.UnregisteredRequiredActionProviderRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUnregisteredRequiredActions indicates an expected call of GetUnregisteredRequiredActions.
func (mr *MockGoCloakIfaceMockRecorder) GetUnregisteredRequiredActions(ctx, token, realm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUnregisteredRequiredActions", reflect.TypeOf((*MockGoCloakIface)(nil).GetUnregisteredRequiredActions), ctx, token, realm)
}

// GetUserBruteForceDetectionStatus mocks base method.
func (m *MockGoCloakIface) GetUserBruteForceDetectionStatus(ctx context.Context, accessToken, realm, userID string) (*v13.BruteForceStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserBruteForceDetectionStatus", ctx, accessToken, realm, userID)
	ret0, _ := ret[0].(*v13.BruteForceStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetUserByID(ctx context.Context, accessToken, realm, userID string) (*v13.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUserCount(ctx context.Context, token, realm string, params v13.GetUsersParams) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUserFederatedIdentities(ctx context.Context, token, realm, userID string) ([]*v13.FederatedIdentityRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserFederatedIdentities", ctx, token, realm, userID)
	ret0, _ := ret[0].([]*v13.FederatedIdentityRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetUserGroups(ctx context.Context, token, realm, userID string, params v13.GetGroupsParams) ([]*v13.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUserInfo(ctx context.Context, accessToken, realm string) (*v13.UserInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserInfo", ctx, accessToken, realm)
	ret0, _ := ret[0].(*v13.UserInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetUserOfflineSessionsForClient(ctx context.Context, token, realm, userID, idOfClient string) ([]*v13.UserSessionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUserPermissions(ctx context.Context, token, realm string, params v13.GetUserPermissionParams) ([]*v13.PermissionGrantResponseRepresentation, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserPermissions", ctx, token, realm, params)
	ret0, _ := ret[0].([]*v13.PermissionGrantResponseRepresentation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) GetUserSessions(ctx context.Context, token, realm, userID string) ([]*v13.UserSessionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUsers(ctx context.Context, token, realm string, params v13.GetUsersParams) ([]*v13.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUsersByClientRoleName(ctx context.Context, token, realm, idOfClient, roleName string, params v13.GetUsersByRoleParams) ([]*v13.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUsersByRoleName(ctx context.Context, token, realm, roleName string, params v13.GetUsersByRoleParams) ([]*v13.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GetUsersManagementPermissions(ctx context.Context, accessToken, realm string) (*v13.ManagementPermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) GrantUserPermission(ctx context.Context, token, realm string, permission v13.PermissionGrantParams) (*v13.PermissionGrantResponseRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) Login(ctx context.Context, clientID, clientSecret, realm, username, password string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) LoginAdmin(ctx context.Context, username, password, realm string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) LoginClient(ctx context.Context, clientID, clientSecret, realm string, scopes ...string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) LoginClientSignedJWT(ctx context.Context, clientID, realm string, key any, signedMethod v5.SigningMethod, expiresAt *v5.NumericDate) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) LoginClientTokenExchange(ctx context.Context, clientID, token, clientSecret, realm, targetClient, userID string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) LoginOtp(ctx context.Context, clientID, clientSecret, realm, username, password, totp string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) RefreshToken(ctx context.Context, refreshToken, clientID, clientSecret, realm string) (*v13.JWT, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) RegenerateClientSecret(ctx context.Context, token, realm, idOfClient string) (*v13.CredentialRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) RegisterRequiredAction(ctx context.Context, token, realm string, requiredAction v13.RequiredActionProviderRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) RestyClient() *v2.Client {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) RetrospectToken(ctx context.Context, accessToken, clientID, clientSecret, realm string) (*v13.IntroSpectTokenResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RetrospectToken", ctx, accessToken, clientID, clientSecret, realm)
	ret0, _ := ret[0].(*v13.IntroSpectTokenResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGoCloakIface) SendVerifyEmail(ctx context.Context, token, userID, realm string, params ...v13.SendVerificationMailParams) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, token, userID, realm}
	for _, a := range params {
		varargs = append(varargs, a)
	}
...
func (mr *MockGoCloakIfaceMockRecorder) SendVerifyEmail(ctx, token, userID, realm any, params ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, token, userID, realm}, params...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendVerifyEmail", reflect.TypeOf((*MockGoCloakIface)(nil).SendVerifyEmail), varargs...)
}
...
func (m *MockGoCloakIface) SetRestyClient(restyClient *v2.Client) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateAuthenticationExecution(ctx context.Context, token, realm, flow string, execution v13.ModifyAuthenticationExecutionRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateAuthenticationFlow(ctx context.Context, token, realm string, flow v13.AuthenticationFlowRepresentation, authenticationFlowID string) (*v13.AuthenticationFlowRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateClient(ctx context.Context, token, realm string, updatedClient v13.Client) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateClientManagementPermissions(ctx context.Context, accessToken, realm, idOfClient string, managementPermissions v13.ManagementPermissionRepresentation) (*v13.ManagementPermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateClientProtocolMapper(ctx context.Context, token, realm, idOfClient, mapperID string, mapper v13.ProtocolMapperRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateClientRepresentation(ctx context.Context, accessToken, realm string, updatedClient v13.Client) (*v13.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateClientScope(ctx context.Context, token, realm string, scope v13.ClientScope) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID string, protocolMapper v13.ProtocolMappers) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateComponent(ctx context.Context, token, realm string, component v13.Component) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateGroup(ctx context.Context, token, realm string, updatedGroup v13.Group) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateGroupManagementPermissions(ctx context.Context, accessToken, realm, idOfGroup string, managementPermissions v13.ManagementPermissionRepresentation) (*v13.ManagementPermissionRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateIdentityProvider(ctx context.Context, token, realm, alias string, providerRep v13.IdentityProviderRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateIdentityProviderMapper(ctx context.Context, token, realm, alias string, mapper v13.IdentityProviderMapper) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdatePermission(ctx context.Context, token, realm, idOfClient string, permission v13.PermissionRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdatePermissionScope(ctx context.Context, token, realm, idOfClient, idOfScope string, policy v13.PolicyRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdatePolicy(ctx context.Context, token, realm, idOfClient string, policy v13.PolicyRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateRealm(ctx context.Context, token string, realm v13.RealmRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateRealmRole(ctx context.Context, token, realm, roleName string, role v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateRealmRoleByID(ctx context.Context, token, realm, roleID string, role v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateRequiredAction(ctx context.Context, token, realm string, requiredAction v13.RequiredActionProviderRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateResource(ctx context.Context, token, realm, idOfClient string, resource v13.ResourceRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateResourceClient(ctx context.Context, token, realm string, resource v13.ResourceRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateResourcePolicy(ctx context.Context, token, realm, permissionID string, policy v13.ResourcePolicyRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateRole(ctx context.Context, token, realm, idOfClient string, role v13.Role) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateScope(ctx context.Context, token, realm, idOfClient string, scope v13.ScopeRepresentation) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateUser(ctx context.Context, token, realm string, user v13.User) error {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateUserPermission(ctx context.Context, token, realm string, permission v13.PermissionGrantParams) (*v13.PermissionGrantResponseRepresentation, error) {
	m.ctrl.T.Helper()
...
func (m *MockGoCloakIface) UpdateUsersManagementPermissions(ctx context.Context, accessToken, realm string, managementPermissions v13.ManagementPermissionRepresentation) (*v13.ManagementPermissionRepresentation, error) {
	m.ctrl.T.Helper()
